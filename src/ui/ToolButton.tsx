...
const PILL =
  'inline-flex items-center gap-2 rounded-full border border-line bg-panel py-1 pr-3.5 pl-1 text-[13px] font-semibold whitespace-nowrap shadow-card transition-colors hover:not-disabled:bg-hover disabled:cursor-not-allowed disabled:opacity-45'
