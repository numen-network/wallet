 ...
 * MetaMaskIcon is web3icons, MIT, web3icons.io. It paints its own brand
 * colours, so currentColor never reaches it.
 *
...
export function MetaMaskIcon({ className = 'size-5' }: IconProps) {
  return (
